...
- [ ] Define the Google-compatible `filler` schema and runtime operation
      validation.
- [ ] Add bounded, abort-aware process execution and capability errors.
- [ ] Register the Pi tool with path normalization, output truncation,
      and file-mutation queue integration.
- [ ] Add focused unit tests for schema dispatch and process failures.

## PDF

- [ ] Implement layout-preserving PDF text reads with optional page
      ranges.
- [ ] Implement page-aware literal and regular-expression search.
- [ ] Render only requested PDF pages to PNG output files.
- [ ] Add deterministic tests using fake command executables.
...
- [ ] Inspect page setup, margins, sections, numbering, comments, tracked
      changes, and core metadata.
- [ ] Patch page setup, margins, line numbering, page numbering, and core
...
- [ ] Update durable architecture, project status, README, and changelog.
